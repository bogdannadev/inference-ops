...
`qw36-27b.bnna.dev` still terminates at the Caddy in `../qwen3.6-27b-2-A100`,
...
network. **The public edge is untouched** — `qw36-27b.bnna.dev` still goes Caddy
...
2. **Scrape the consumer counters** into the A100 node's Prometheus and build a
   per-consumer panel.
3. **Public hostname.** Add `qw36-27b-gw.bnna.dev` as a NEW Caddy site pointing
