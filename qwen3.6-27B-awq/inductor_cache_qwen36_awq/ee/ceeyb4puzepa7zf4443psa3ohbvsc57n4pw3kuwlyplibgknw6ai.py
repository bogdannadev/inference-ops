...
# kernel path: /root/.cache/inductor/4q/c4qkc4kfpwh5alcmqxyxc56izfpe3flnr2nde7q7btvs3fcmnpzh.py
...
#   %ge : Tensor "b8[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.ge.Scalar](args = (%arg1_1, %arg2_1), kwargs = {})
#   %lt : Tensor "b8[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.lt.Scalar](args = (%arg1_1, %arg3_1), kwargs = {})
#   %bitwise_and : Tensor "b8[1][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.bitwise_and.Tensor](args = (%ge, %lt), kwargs = {})
#   %ge_1 : Tensor "b8[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.ge.Scalar](args = (%arg1_1, %arg4_1), kwargs = {})
#   %lt_1 : Tensor "b8[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.lt.Scalar](args = (%arg1_1, %arg5_1), kwargs = {})
...
#   %mul : Tensor "i64[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bitwise_and, %arg2_1), kwargs = {})
...
#   %sub_3 : Tensor "i64[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg1_1, %add), kwargs = {})
...
# kernel path: /root/.cache/inductor/mn/cmntoo75xv5jr26dns7v3angkrapi4pwrhujh7hp43e36yngsc3j.py
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            triton_poi_fused_add_bitwise_and_bitwise_or_ge_lt_mul_sub_0.run(arg1_1, buf0, s90, s87, s68, s53, s88, 1, stream=stream0)
            buf1 = empty_strided_cuda((1, ), (1, ), torch.bool)
            # Topologically Sorted Source Nodes: [ge, lt, org_vocab_mask, ge_1, lt_1, added_vocab_mask, vocab_mask, invert], Original ATen: [aten.ge, aten.lt, aten.bitwise_and, aten.bitwise_or, aten.bitwise_not]
            stream0 = get_raw_stream(0)
            triton_poi_fused_bitwise_and_bitwise_not_bitwise_or_ge_lt_1.run(arg1_1, buf1, s90, s87, s68, s53, 1, stream=stream0)
            del arg1_1
        return (buf0, buf1, )
