...
# Graph fragment:
#   %arg2_1 : Tensor "i64[s15, s0][s0, 1]cuda:1" = PlaceHolder[target=arg2_1]
#   %ge : Tensor "b8[s15, s0][s0, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.ge.Scalar](args = (%arg2_1, %arg3_1), kwargs = {})
#   %lt : Tensor "b8[s15, s0][s0, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.lt.Scalar](args = (%arg2_1, %arg4_1), kwargs = {})
#   %bitwise_and : Tensor "b8[s15, s0][s0, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.bitwise_and.Tensor](args = (%ge, %lt), kwargs = {})
#   %ge_1 : Tensor "b8[s15, s0][s0, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.ge.Scalar](args = (%arg2_1, %arg5_1), kwargs = {})
#   %lt_1 : Tensor "b8[s15, s0][s0, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.lt.Scalar](args = (%arg2_1, %arg6_1), kwargs = {})
#   %bitwise_and_1 : Tensor "b8[s15, s0][s0, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.bitwise_and.Tensor](args = (%ge_1, %lt_1), kwargs = {})
#   %bitwise_or : Tensor "b8[s15, s0][s0, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.bitwise_or.Tensor](args = (%bitwise_and, %bitwise_and_1), kwargs = {})
#   %mul_6 : Tensor "i64[s15, s0][s0, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bitwise_and, %arg3_1), kwargs = {})
#   %mul_9 : Tensor "i64[s15, s0][s0, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bitwise_and_1, %sub_14), kwargs = {})
#   %add_24 : Tensor "i64[s15, s0][s0, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_6, %mul_9), kwargs = {})
#   %sub_23 : Tensor "i64[s15, s0][s0, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg2_1, %add_24), kwargs = {})
#   %mul_17 : Tensor "i64[s15, s0][s0, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bitwise_or, %sub_23), kwargs = {})
#   %bitwise_not : Tensor "b8[s15, s0][s0, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.bitwise_not.default](args = (%bitwise_or,), kwargs = {})
