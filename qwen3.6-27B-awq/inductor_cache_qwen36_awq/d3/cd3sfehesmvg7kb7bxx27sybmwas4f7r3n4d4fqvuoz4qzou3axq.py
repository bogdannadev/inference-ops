...
# Graph fragment:
#   %arg2_1 : Tensor "bf16[1, s98][s98, 1]cuda:0" = PlaceHolder[target=arg2_1]
#   %unsqueeze : Tensor "bf16[1, 1, s98][s98, s98, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%arg2_1, 1), kwargs = {})
#   %clone : Tensor "bf16[1, 1, s98][s98, s98, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%expand,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            triton_poi_fused_clone_unsqueeze_0.run(arg2_1, buf0, s98, stream=stream0)
            del arg2_1
